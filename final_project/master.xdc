...
create_clock -add -name sys_clk_pin -period 1600000.00 -waveform {0 5} [get_ports {CLK100MHZ}];
...
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L22P_T3_A17_15 Sch=ja[10]
...
#set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { nothing }]; #IO_L22P_T3_35 Sch=jc[8]
...
##Pmod Header JXADC
#set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { in1 }]; #IO_L9N_T1_DQS_AD3N_15 Sch=xa_n[1]
## high
#set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS33 } [get_ports { in2 }]; #IO_L9P_T1_DQS_AD3P_15 Sch=xa_p[1]
## high
#set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { in3 }]; #IO_L8N_T1_AD10N_15 Sch=xa_n[2]
#set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { in4 }]; #IO_L8P_T1_AD10P_15 Sch=xa_p[2]
